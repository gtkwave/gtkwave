...
const GwColor *gw_rainbow_color_to_color(GwRainbowColor self)
{
    ...
    static const GwColor RAINBOW_COLORS[GW_NUM_RAINBOW_COLORS] = {
        ...
        {0.4, 0.0, 1.0, 1.0}, // Indigo
        {0.6, 0.0, 1.0, 1.0}, // Violet
        {1.0, 1.0, 1.0, 1.0}, // White
        {0.85, 0.85, 0.85, 1.0}, // Silver
        {0.625, 0.625, 0.65, 1.0}, // Gray
        {0.5, 0.5, 0.5, 1.0}, // Light Gray
        {0.875, 1.0, 1.0, 1.0}, // Light Cyan
        {0.0, 1.0, 1.0, 1.0}, // Aqua
        {0.0, 0.5, 0.5, 1.0}, // Teal
        {0.0, 0.0, 0.625, 1.0}, // Dark Blue
        {0.0, 1.0, 0.5, 1.0}, // Spring Green
        {0.0, 0.5, 0.0, 1.0}, // Green
        {0.5, 0.5, 0.0, 1.0}, // Olive
        {0.94, 0.9, 0.55, 1.0}, // Khaki
        {1.0, 0.84, 0.0, 1.0}, // Gold
        {0.82, 0.41, 0.12, 1.0}, // Chocolate
        {0.7, 0.8, 0.5, 1.0}, // Brown
        {0.98, 0.68, 0.74, 1.0}, // Pink
        {1.0, 0.0, 1.0, 1.0}, // Magenta
        {1.0, 0.0, 0.5, 1.0}, // Light Purple
