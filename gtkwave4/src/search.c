...
static void entrybox_local(char *title, int width, char *default_text, int maxch, GCallback func)
{
    ...
    gtkwave_signal_connect(GLOBALS->window1_search_c_2, "delete_event",(GCallback) destroy_callback_e, NULL);
    ...
    gtkwave_signal_connect(GLOBALS->entry_a_search_c_1, "activate",G_CALLBACK(enter_callback_e),GLOBALS->entry_a_search_c_1);
...
void searchbox(char *title, GCallback func)
{
    ...
    gtkwave_signal_connect(GLOBALS->window_search_c_7, "delete_event",(GCallback) destroy_callback, NULL);
    ...
    gtkwave_signal_connect(GLOBALS->entry_search_c_3, "activate", G_CALLBACK(search_enter_callback),GLOBALS->entry_search_c_3);
    ...
    gtkwave_signal_connect_object (button6, "clicked",G_CALLBACK(select_all_callback),GLOBALS->window_search_c_7);
...
g_signal_connect (combo_box, "changed", G_CALLBACK (on_changed), NULL);
    ...
    gtkwave_signal_connect_object (button7, "clicked",G_CALLBACK(unselect_all_callback),GLOBALS->window_search_c_7);
    ...
    gtkwave_signal_connect_object (button1, "clicked",G_CALLBACK(ok_callback),GLOBALS->window_search_c_7);
    gtk_widget_show (button1);
    ...
    gtkwave_signal_connect_object (button2, "clicked",G_CALLBACK(insert_callback),GLOBALS->window_search_c_7);
    gtk_widget_show (button2);
	...
	button3 = gtk_button_new_with_label (" Bundle Up ");
    	...
    	gtkwave_signal_connect_object (button3, "clicked",G_CALLBACK(bundle_callback_up),GLOBALS->window_search_c_7);
    	...
    	gtkwave_signal_connect_object (button3a, "clicked",G_CALLBACK(bundle_callback_down),GLOBALS->window_search_c_7);
    ...
    gtkwave_signal_connect_object (button4, "clicked",G_CALLBACK(replace_callback),GLOBALS->window_search_c_7);
    ...
    gtkwave_signal_connect_object (button5, "clicked",G_CALLBACK(destroy_callback),GLOBALS->window_search_c_7);
