...
void trans_searchbox(char *title)
{
    ...
    gtkwave_signal_connect(GLOBALS->window_translate_c_11, "delete_event",(GCallback) destroy_callback, NULL);
    ...
    gtkwave_signal_connect_object (button6, "clicked",G_CALLBACK(add_filter_callback),GLOBALS->window_translate_c_11);
    ...
    gtkwave_signal_connect_object (button1, "clicked",G_CALLBACK(ok_callback),GLOBALS->window_translate_c_11);
    ...
    gtkwave_signal_connect_object (button5, "clicked",G_CALLBACK(destroy_callback),GLOBALS->window_translate_c_11);
