...
static int gtkwavetcl_badNumArgs(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[],
                                 int expected)
{
    ...
    sprintf(reportString,
            "* wrong number of arguments for '%s': %d expected, %d encountered",
...
static int gtkwavetcl_nop(ClientData clientData,
                          Tcl_Interp *interp,
                          int objc,
                          Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_printInteger(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[],
                                   int intVal)
...
static int gtkwavetcl_printTimeType(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[],
                                    GwTime ttVal)
...
static int gtkwavetcl_printTraceFlagsType(ClientData clientData,
                                          Tcl_Interp *interp,
                                          int objc,
                                          Tcl_Obj *CONST objv[],
                                          TraceFlagsType ttVal)
{
    (void)clientData;
    (void)objc;
    (void)objv;
...
static int gtkwavetcl_printDouble(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[],
                                  double dVal)
...
static int gtkwavetcl_printString(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[],
...
static int gtkwavetcl_getNumFacs(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getFacDir(ClientData clientData,
                                Tcl_Interp *interp,
                                int objc,
                                Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getFacVtype(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getFacDtype(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getMinTime(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getMaxTime(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTimeZero(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTimeDimension(ClientData clientData,
                                       Tcl_Interp *interp,
                                       int objc,
                                       Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getArgv(ClientData clientData,
                              Tcl_Interp *interp,
                              int objc,
                              Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getBaselineMarker(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getMarker(ClientData clientData,
                                Tcl_Interp *interp,
                                int objc,
                                Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getWindowStartTime(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getWindowEndTime(ClientData clientData,
                                       Tcl_Interp *interp,
                                       int objc,
                                       Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getDumpType(ClientData clientData,
                                  Tcl_Interp *interp,
                                  int objc,
                                  Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getNamedMarker(ClientData clientData,
                                     Tcl_Interp *interp,
                                     int objc,
                                     Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getWaveHeight(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getWaveWidth(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getPixelsUnitTime(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getUnitTimePixels(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getZoomFactor(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getDumpFileName(ClientData clientData,
                                      Tcl_Interp *interp,
                                      int objc,
                                      Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getVisibleNumTraces(ClientData clientData,
                                          Tcl_Interp *interp,
                                          int objc,
                                          Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTotalNumTraces(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceNameFromIndex(ClientData clientData,
                                            Tcl_Interp *interp,
                                            int objc,
                                            Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceFlagsFromIndex(ClientData clientData,
                                             Tcl_Interp *interp,
                                             int objc,
                                             Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        if ((which >= 0) && (which < GLOBALS->traces.total)) {
            ...
            while (t) {
                if (i == which) {
                    return (
                        gtkwavetcl_printTraceFlagsType(clientData, interp, objc, objv, t->flags));
                }
...
static int gtkwavetcl_getTraceValueAtMarkerFromIndex(ClientData clientData,
                                                     Tcl_Interp *interp,
                                                     int objc,
                                                     Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceValueAtMarkerFromName(ClientData clientData,
                                                    Tcl_Interp *interp,
                                                    int objc,
                                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceValueAtNamedMarkerFromName(ClientData clientData,
                                                         Tcl_Interp *interp,
                                                         int objc,
                                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getHierMaxLevel(ClientData clientData,
                                      Tcl_Interp *interp,
                                      int objc,
                                      Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getFontHeight(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getLeftJustifySigs(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getSaveFileName(ClientData clientData,
                                      Tcl_Interp *interp,
                                      int objc,
                                      Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getStemsFileName(ClientData clientData,
                                       Tcl_Interp *interp,
                                       int objc,
                                       Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceScrollbarRowValue(ClientData clientData,
                                                Tcl_Interp *interp,
                                                int objc,
                                                Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setMarker(ClientData clientData,
                                Tcl_Interp *interp,
                                int objc,
                                Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setBaselineMarker(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setWindowStartTime(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setZoomFactor(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setZoomRangeTimes(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
    if (objc == 3) {
        ...
        if (time1 > GLOBALS->tims.last) {
            time1 = GLOBALS->tims.last;
        }
        if (time2 < GLOBALS->tims.first) {
            time2 = GLOBALS->tims.first;
        }
        if (time2 > GLOBALS->tims.last) {
            time2 = GLOBALS->tims.last;
        }
...
static int gtkwavetcl_setLeftJustifySigs(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setNamedMarker(ClientData clientData,
                                     Tcl_Interp *interp,
                                     int objc,
                                     Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setTraceScrollbarRowValue(ClientData clientData,
                                                Tcl_Interp *interp,
                                                int objc,
                                                Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        /* 	if(target > GLOBALS->traces.visible - num_traces_displayable) target =
         * GLOBALS->traces.visible - num_traces_displayable; */
...
static int gtkwavetcl_addSignalsFromList(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_processTclList(ClientData clientData,
                                     Tcl_Interp *interp,
                                     int objc,
                                     Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_deleteSignalsFromList(ClientData clientData,
                                            Tcl_Interp *interp,
                                            int objc,
                                            Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_deleteSignalsFromListIncludingDuplicates(ClientData clientData,
                                                               Tcl_Interp *interp,
                                                               int objc,
                                                               Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_highlightSignalsFromList(ClientData clientData,
                                               Tcl_Interp *interp,
                                               int objc,
                                               Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_unhighlightSignalsFromList(ClientData clientData,
                                                 Tcl_Interp *interp,
                                                 int objc,
                                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setTraceHighlightFromIndex(ClientData clientData,
                                                 Tcl_Interp *interp,
                                                 int objc,
                                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setTraceHighlightFromNameMatch(ClientData clientData,
                                                     Tcl_Interp *interp,
                                                     int objc,
                                                     Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_signalChangeList(ClientData clientData,
                                       Tcl_Interp *interp,
                                       int objc,
                                       Tcl_Obj *CONST objv[])
{
                ...
                case 'd': /* dir */
                    if (!strstr("-dir", str_p))
                        ...
                        if (strstr("forward", str1_p))
                            dir = STRACE_FORWARD;
                        else if (strstr("backward", str1_p))
                            dir = STRACE_BACKWARD;
                        else
                            error++;
                    }
    ...
    if (error) {
        Tcl_SetObjResult(interp,
                         Tcl_NewStringObj("Usage: signal_change_list ?name? ?-start time? ?-end "
                                          "time? ?-max size? ?-dir forward|backward?",
                                          -1));
        return TCL_ERROR;
    }
...
static int gtkwavetcl_findNextEdge(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_findPrevEdge(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_forceOpenTreeNode(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
    ...
    Tcl_SetObjResult(GLOBALS->interp,
                     (rv == SST_NODE_CURRENT)
...
static int gtkwavetcl_setFromEntry(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setToEntry(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getFromEntry(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getToEntry(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getDisplayedSignals(ClientData clientData,
                                          Tcl_Interp *interp,
                                          int objc,
                                          Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getTraceFlagsFromName(ClientData clientData,
                                            Tcl_Interp *interp,
                                            int objc,
                                            Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_loadFile(ClientData clientData,
                               Tcl_Interp *interp,
                               int objc,
                               Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        if (!GLOBALS->in_tcl_callback) {
            ...
            gtkwavetcl_setvar_nonblocking(WAVE_TCLCB_ERROR,
                                          "gtkwave::loadFile prohibited in callback",
                                          WAVE_TCLCB_ERROR_FLAGS);
        }
    } else {
        return (gtkwavetcl_badNumArgs(clientData, interp, objc, objv, 1));
    }
...
static int gtkwavetcl_reLoadFile(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
    if (objc == 1) {
        if (!GLOBALS->in_tcl_callback) {
            ...
            gtkwavetcl_setvar_nonblocking(WAVE_TCLCB_ERROR,
                                          "gtkwave::reLoadFile prohibited in callback",
                                          WAVE_TCLCB_ERROR_FLAGS);
        }
    } else {
...
static int gtkwavetcl_presentWindow(ClientData clientData,
                                    Tcl_Interp *interp,
                                    int objc,
                                    Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_showSignal(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setTabActive(ClientData clientData,
                                   Tcl_Interp *interp,
                                   int objc,
                                   Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_getNumTabs(ClientData clientData,
                                 Tcl_Interp *interp,
                                 int objc,
                                 Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_installFileFilter(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setCurrentTranslateFile(ClientData clientData,
                                              Tcl_Interp *interp,
                                              int objc,
                                              Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        return (gtkwavetcl_printInteger(clientData,
                                        interp,
                                        objc,
                                        objv,
                                        GLOBALS->current_translate_file));
    } else {
        return (gtkwavetcl_badNumArgs(clientData, interp, objc, objv, 1));
    }
}

static int gtkwavetcl_setCurrentTranslateEnums(ClientData clientData,
                                               Tcl_Interp *interp,
                                               int objc,
                                               Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_installProcFilter(ClientData clientData,
                                        Tcl_Interp *interp,
                                        int objc,
                                        Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setCurrentTranslateProc(ClientData clientData,
                                              Tcl_Interp *interp,
                                              int objc,
                                              Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        return (gtkwavetcl_printInteger(clientData,
                                        ...
                                        objc,
                                        objv,
                                        GLOBALS->current_translate_proc));
    } else {
        return (gtkwavetcl_badNumArgs(clientData, interp, objc, objv, 1));
    }
}

static int gtkwavetcl_installTransFilter(ClientData clientData,
                                         Tcl_Interp *interp,
                                         int objc,
                                         Tcl_Obj *CONST objv[])
{
...
static int gtkwavetcl_setCurrentTranslateTransProc(ClientData clientData,
                                                   Tcl_Interp *interp,
                                                   int objc,
                                                   Tcl_Obj *CONST objv[])
{
    if (objc == 2) {
        ...
        return (gtkwavetcl_printInteger(clientData,
                                        ...
                                        objc,
                                        objv,
                                        GLOBALS->current_translate_ttrans));
    } else {
        return (gtkwavetcl_badNumArgs(clientData, interp, objc, objv, 1));
    }
}
...
tcl_cmdstruct gtkwave_commands[] = {
    ...
    {"signalChangeList",
     gtkwavetcl_signalChangeList}, /* changed from signal_change_list for consistency! */
