...
static const LabeledUint64 ATTRIBUTES[] = {{"Right Justify", TR_RJUSTIFY},
                                           {"Invert", TR_INVERT},
                                           {"Reverse", TR_REVERSE},
                                           {"Exclude", TR_EXCLUDE},
                                           {"Popcnt", TR_POPCNT},
...
static const LabeledUint64 BASES[] = {{"Hex", TR_HEX},
                                      {"Decimal", TR_DEC},
...
static const LabeledInt64 COLORS[] = {{"Normal", -1},
                                      ...
                                      {"Lime", GW_RAINBOW_COLOR_LIME},
                                      {"Blue", GW_RAINBOW_COLOR_BLUE},
                                      {"Indigo", GW_RAINBOW_COLOR_INDIGO},
                                      {"Violet", GW_RAINBOW_COLOR_VIOLET},
                                      {"White", GW_RAINBOW_COLOR_WHITE},
                                      {"Silver", GW_RAINBOW_COLOR_SILVER},
                                      {"Gray", GW_RAINBOW_COLOR_GRAY},
                                      {"Light Gray", GW_RAINBOW_COLOR_LGRAY},
                                      {"Light Cyan", GW_RAINBOW_COLOR_LCYAN},
                                      {"Aqua", GW_RAINBOW_COLOR_AQUA},
                                      {"Teal", GW_RAINBOW_COLOR_TEAL},
                                      {"Dark Blue", GW_RAINBOW_COLOR_DBLUE},
                                      {"Spring Green", GW_RAINBOW_COLOR_SGREEN},
                                      {"Green", GW_RAINBOW_COLOR_GREEN},
                                      {"Olive", GW_RAINBOW_COLOR_OLIVE},
                                      {"Khaki", GW_RAINBOW_COLOR_KHAKI},
                                      {"Gold", GW_RAINBOW_COLOR_GOLD},
                                      {"Chocolate", GW_RAINBOW_COLOR_CHOCOLATE},
                                      {"Brown", GW_RAINBOW_COLOR_BROWN},
                                      {"Pink", GW_RAINBOW_COLOR_PINK},
                                      {"Magenta", GW_RAINBOW_COLOR_MAGENTA},
                                      {"Light Purple", GW_RAINBOW_COLOR_LPURPLE},
                                      {"Purple", GW_RAINBOW_COLOR_PURPLE},
                                      {"Maroon", GW_RAINBOW_COLOR_MAROON},
                                      {}};
...
static const LabeledUint64 ANALOG_RESIZING[] = {{"Screen Data", 0},
...
void showchange(const char *title, GwTrace *t, GCallback func)
{
    ...
    GtkWidget *dialog =
        gtk_dialog_new_with_buttons("Trace Properties",
    ...
    GtkWidget *analog_format_combo_box =
        flags_combo_box_new(ANALOG_FORMATS, old_flags & TR_ANALOGMASK);
    add_labeled_widget(grid, "Format", analog_format_combo_box);

    GtkWidget *analog_resizing_combo_box =
        flags_combo_box_new(ANALOG_RESIZING, old_flags & TR_ANALOG_FULLSCALE);
