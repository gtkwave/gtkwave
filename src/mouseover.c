...
static void create_mouseover(gint x, gint y, gint width, gint height)
{
    ...
    if (GDK_IS_WAYLAND_DISPLAY(gdk_display_get_default())) {
        ...
        gtk_window_group_add_window(gtk_window_get_group(GTK_WINDOW(GLOBALS->mainwindow)),
                                    GTK_WINDOW(GLOBALS->mouseover_mouseover_c_1));
        gtk_window_set_transient_for(GTK_WINDOW(GLOBALS->mouseover_mouseover_c_1),
                                     GTK_WINDOW(GLOBALS->mainwindow));
        gtk_container_add(GTK_CONTAINER(GLOBALS->mouseover_mouseover_c_1),
                          GLOBALS->mo_area_mouseover_c_1);
        gtk_widget_realize(GLOBALS->mouseover_mouseover_c_1);
        gtk_window_set_type_hint(GTK_WINDOW(GLOBALS->mouseover_mouseover_c_1),
    ...
    XXX_gdk_draw_rectangle(GLOBALS->cr_mo_pixmap_mouseover_c_1,
                           ...
                           0,
                           0,
                           GLOBALS->mo_width_mouseover_c_1,
                           GLOBALS->mo_height_mouseover_c_1);
    ...
    XXX_gdk_draw_rectangle(GLOBALS->cr_mo_pixmap_mouseover_c_1,
                           ...
                           1,
                           1,
                           GLOBALS->mo_width_mouseover_c_1 - 2,
                           GLOBALS->mo_height_mouseover_c_1 - 2);
...
void move_mouseover(Trptr t, gint xin, gint yin, GwTime tim)
{
    ...
    if (t) {
        ...
        if (GLOBALS->clipboard_mouseover) {
            ...
            if (t->name) {
                clip =
                    gtk_clipboard_get_for_display(g,
                                                  GDK_SELECTION_PRIMARY); /* middle mouse button */
        ...
        if (num_info_rows > MOUSEOVER_BREAKSIZE_ROWS)
            num_info_rows = MOUSEOVER_BREAKSIZE_ROWS; /* prevent possible X11 overflow */
        ...
        if ((GLOBALS->mouseover_mouseover_c_1) &&
            ((totalmax != GLOBALS->mo_width_mouseover_c_1) ||
             ((num_info_rows * fh + 7) != GLOBALS->mo_height_mouseover_c_1))) {
            gtk_widget_destroy(GLOBALS->mouseover_mouseover_c_1);
            GLOBALS->mouseover_mouseover_c_1 = NULL;
    ...
    if (!GLOBALS->cr_mo_pixmap_mouseover_c_1)
        goto bot; /* harden against NULL pointer */
    ...
    XXX_gdk_draw_rectangle(GLOBALS->cr_mo_pixmap_mouseover_c_1,
                           GLOBALS->rgb_mo_black_mouseover_c_1,
                           TRUE,
                           1,
                           1,
                           GLOBALS->mo_width_mouseover_c_1 - 2,
    ...
    XXX_font_engine_draw_string(GLOBALS->cr_mo_pixmap_mouseover_c_1,
                                GLOBALS->wavefont,
                                &GLOBALS->rgb_mo_dk_gray_mouseover_c_1,
                                4 + 0.5,
                                fh + 2 + 0.5,
                                alternate_name ? alternate_name : flagged_name);
    ...
    cairo_t *cr = XXX_gdk_cairo_create(
        XXX_GDK_DRAWABLE(gtk_widget_get_window(GLOBALS->mo_area_mouseover_c_1)),
        &gdc);
    cairo_set_source_surface(cr, GLOBALS->surface_mo_pixmap_mouseover_c_1, 0, 0);
    cairo_paint(cr);
#ifdef WAVE_ALLOW_GTK3_CAIRO_CREATE_FIX
...
#ifdef GDK_WINDOWING_WAYLAND
    if (GDK_IS_WAYLAND_DISPLAY(gdk_display_get_default()))
        gtk_widget_queue_draw(GLOBALS->mo_area_mouseover_c_1);
#endif
