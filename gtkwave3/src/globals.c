...
NULL, /* hiericon_sv_array_pixmap */
NULL, /* hiericon_sv_array_mask */
...
void clone_icon_pointers_across_contexts(struct Global *a, struct Global *b)
{
 ...
 a->hiericon_sv_array_pixmap = b->hiericon_sv_array_pixmap;
 a->hiericon_sv_array_mask = b->hiericon_sv_array_mask;
